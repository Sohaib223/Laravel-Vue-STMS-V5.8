            ...
            <div class="hero-static col-md-12 col-xl-12 d-none d-md-flex align-items-md-end">
                <div class="p-30 invisible" data-toggle="appear">
                    <p class="font-size-h3 font-w600 text-white mb-5">
                        Thankyou For Your Registration. You Account Will be Approved Shortly
                    </p>
                    <p class="font-size-h5 text-white">
                    <i class="fa fa-angles-right"></i> Note: You Cannot Log In Until You Click The Link We Send You To Your Email. <a href="{{url('login')}}" style="color: black;
