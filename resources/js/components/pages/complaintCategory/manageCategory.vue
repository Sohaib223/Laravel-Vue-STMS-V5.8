        ...
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              <h3 class="block-title">Complaints Category List</h3>
              <div class="block-options">
                <router-link to="/complaintCategory/create" class="btn btn-info">Add Categories</router-link>
              </div>
            </div>
                ...
                <table class="table table-striped table-vcenter" style="border-color:white">
                    ...
                    <tr>
                      ...
                      <th>
                        <span
                          ...
                          class="nameOrderAsc"
                          @click="changeSorting($event,'nameOrderDesc','nameOrderAsc','category_name','DESC')"
                        >
                        ...
                        <span
                          ...
                          class="nameOrderDesc"
                          @click="changeSorting($event,'nameOrderAsc','nameOrderDesc','category_name','ASC')"
                        >
                  ...
                  <tbody>
                    <tr v-for="(data,i) in table_data.data">
                      ...
                      <td>
                        <router-link
                          :to="'/complaintCategory/'+data.id+'/edit'"
  ...
  methods: {
    ...
    deleteRecord(item_id) {
      ...
      swal(
        ...
        function() {
          axios
            .post(_this.baseurl + "/api/complaintCategory/" + item_id, {
              _method: "DELETE"
            })
            .then(response => {
