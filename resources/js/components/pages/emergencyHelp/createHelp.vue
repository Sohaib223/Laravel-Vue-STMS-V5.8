        ...
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              <h3 class="block-title">Create Emergency Help</h3>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      axios
        .get(_this.baseurl + "/api/emergencyHelp/create")
        .then(response => {
    ...
    submitForm(e) {
      ...
      axios
        .post(_this.baseurl + "/api/emergencyHelp", _this.myForm)
        .then(response => {
          ...
          if (response.data * 1 === 1) {
            ...
            _this.$router.push({ name: "manageEmergencyHelp" });
