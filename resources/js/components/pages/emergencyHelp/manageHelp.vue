        ...
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              <h3 class="block-title">Emergencies List</h3>
              <div class="block-options">
                <router-link to="/emergencyHelp/create" class="btn btn-info">Add Emergencies</router-link>
              </div>
            </div>
                ...
                <table class="table table-striped table-vcenter" style="border-color:white">
                  ...
                  <tbody>
                    <tr v-for="(data,i) in table_data.data">
                      ...
                      <td>{{ data.location_name }}, {{data.address}}</td>
                      <td v-if="role_id*1 == 1">
                        <router-link
                          :to="'/emergencyHelp/'+data.id+'/edit'"
  ...
  methods: {
    ...
    deleteRecord(item_id) {
      ...
      swal(
        ...
        function() {
          axios
            .post(_this.baseurl + "/api/emergencyHelp/" + item_id, {
              _method: "DELETE"
            })
            .then(response => {
