          ...
          <div class="block">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <router-link to="/customer" class="btn btn-info">Manage customers</router-link>
                <router-link to="/customer/create" class="btn btn-info">Add customers</router-link>
              </div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div :class="['form-group',(allerrors.status) ? 'is-invalid' : '']">
                      <div class="form-material">
                        <select class="form-control" v-model="myForm.status">
                  ...
                  <div class="col-md-6">
                    <div :class="['form-group',(allerrors.is_verified) ? 'is-invalid' : '']">
                      <div class="form-material">
                        <select class="form-control" v-model="myForm.is_verified">
                          <option value="0">Unverified</option>
                          <option value="1">Verified</option>
                        </select>
                        <label for="material-text2">Verification</label>
                      </div>
                      <div
                        v-if="allerrors.is_verified"
                        v-for="error_name in allerrors.is_verified"
                        class="invalid-feedback"
                      >{{error_name}}</div>
                    </div>
                  </div>
        ...
        .then(response => {
          ...
          setTimeout(function() {
            var profile_url =
              _this.baseurl +
              "/public/uploads/" +
              response.data.customer.id_prove;

            //console.log(profile_url);
            $(".dropify").attr("data-default-file", profile_url);
            $(".dropify").dropify();
          }, 800);
        })
        .catch(error => {
