          ...
          <div class="block">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <router-link to="/feedback/create" class="btn btn-info">Add Feedbacks</router-link>
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <th>
                        <span
                          ...
                          class="nameOrderAsc"
                          @click="changeSorting($event,'nameOrderDesc','nameOrderAsc','description','DESC')"
                        >
                        ...
                        <span
                          ...
                          class="nameOrderDesc"
                          @click="changeSorting($event,'nameOrderAsc','nameOrderDesc','description','ASC')"
                        >
  ...
  methods: {
    ...
    deleteRecord(item_id) {
      ...
      swal(
        ...
        function() {
          axios
            .post(_this.baseurl + "/api/feedback/" + item_id, {
              _method: "DELETE"
            })
            .then(response => {
