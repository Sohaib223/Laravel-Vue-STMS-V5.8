        ...
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              <h3 class="block-title">Add New Complaint</h3>
              <div class="block-options">
                <router-link to="/complaint" class="btn btn-info">Manage Complaint</router-link>
              </div>
            </div>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      axios
        .get(_this.baseurl + "/api/complaint/create")
        .then(response => {
    ...
    submitForm(e) {
      ...
      axios
        .post(_this.baseurl + "/api/complaint", _this.myForm)
        .then(response => {
          ...
          if (response.data * 1 === 1) {
            ...
            _this.$router.push({ name: "manageComplaint" });
